...
val awsServerless20161031ResourceTypes = listOf(
    CloudFormationManualResourceType(
        ...
        properties = listOf(
            ...
            CloudFormationManualResourceProperty(name = "FunctionName", type = "string", description = "A name for the function. If you don't specify a name, a unique name will be generated for you. More Info"),
            ...
            CloudFormationManualResourceProperty(name = "Role", type = "string", description = "ARN of an IAM role to use as this function's execution role. If omitted, a default role is created for this function."),
            ...
            CloudFormationManualResourceProperty(name = "Events", type = "Map of string to Event source object", description = "A map (string to Event source object) that defines the events that trigger this function. Keys are limited to alphanumeric characters."),
    ...
    CloudFormationManualResourceType(
        ...
        properties = listOf(
            ...
            CloudFormationManualResourceProperty(name = "StageName", type = "string", description = "The name of the stage, which API Gateway uses as the first path segment in the invoke Uniform Resource Identifier (URI).", required = true),
