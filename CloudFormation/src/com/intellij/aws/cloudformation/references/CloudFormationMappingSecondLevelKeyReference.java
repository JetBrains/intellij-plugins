...
public class CloudFormationMappingSecondLevelKeyReference extends CloudFormationReferenceBase {
  ...
  public PsiElement resolve() {
    final String entityName = CloudFormationResolve.getTargetName(myElement);
    return CloudFormationResolve.resolveSecondLevelMappingKey(myElement.getContainingFile(), myMappingName, myTopLevelKey, entityName);
  }

  @NotNull
  public String[] getCompletionVariants() {
    final String[] keys = CloudFormationResolve.getSecondLevelMappingKeys(myElement.getContainingFile(), myMappingName, myTopLevelKey);
