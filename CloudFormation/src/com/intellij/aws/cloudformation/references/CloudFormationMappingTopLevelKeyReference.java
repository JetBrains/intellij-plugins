...
public class CloudFormationMappingTopLevelKeyReference extends CloudFormationReferenceBase {
  ...
  public PsiElement resolve() {
    ...
    return CloudFormationResolve.resolveTopLevelMappingKey(myElement.getContainingFile(), myMappingName, entityName);
  }

  @NotNull
  public String[] getCompletionVariants() {
    final String[] keys = CloudFormationResolve.getTopLevelMappingKeys(myElement.getContainingFile(), myMappingName);
