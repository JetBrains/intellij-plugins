...
val awsServerlessApi = CloudFormationManualResourceType(
    ...
    properties = listOf(
        ...
        CloudFormationManualResourceProperty(name = "Description", type = "string", description = "A description for the API Gateway RestApi resource"),
        CloudFormationManualResourceProperty(name = "Domain", type = "CloudFormation DomainConfiguration Object",
                                             description = "Configures a custom domain for this API Gateway API.",
                                             url = "https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/sam-property-api-domainconfiguration.html"),
        ...
        CloudFormationManualResourceProperty(name = "GatewayResponses", type = "Map of Gateway Response Type to Gateway Response Object", description = "Configures Gateway Responses for an API. Gateway Responses are responses returned by API Gateway, either directly or through the use of Lambda Authorizers. Keys for this object are passed through to Api Gateway, so any value supported by GatewayResponse.responseType is supported here."),
