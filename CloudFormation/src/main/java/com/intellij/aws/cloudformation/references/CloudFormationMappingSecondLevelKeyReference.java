...
public class CloudFormationMappingSecondLevelKeyReference extends CloudFormationReferenceBase {
  ...
  public PsiElement resolve() {
    ...
    return CloudFormationResolve.Companion.resolveSecondLevelMappingKey(myElement.getContainingFile(), myMappingName, myTopLevelKey, entityName);
  }

  @NotNull
  public String[] getCompletionVariants() {
    final String[] keys = CloudFormationResolve.Companion.getSecondLevelMappingKeys(myElement.getContainingFile(), myMappingName, myTopLevelKey);
