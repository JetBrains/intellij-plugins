...
public class OgnlLiteralExpressionImpl extends OgnlExpressionImpl implements OgnlLiteralExpression {
  ...
  public OgnlLiteralExpressionImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof OgnlVisitor) ((OgnlVisitor)visitor).visitLiteralExpression(this);
    else super.accept(visitor);
  }

  @Nullable
  public Object getConstantValue() {
    return OgnlPsiUtil.getConstantValue(this);
  }
