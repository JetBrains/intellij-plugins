...
<YYINITIAL> {ONELINECOMMENT}/{LINE_TERMINATOR} {return CfscriptTokenTypes.COMMENT;}
...
<YYINITIAL,EXPRESSION, X, Y,COMMENT, COMMENTEND> {WHITE_SPACE_CHAR} {return CfscriptTokenTypes.WHITE_SPACE; }
