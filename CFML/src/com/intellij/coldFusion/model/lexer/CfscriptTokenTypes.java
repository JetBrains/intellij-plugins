...
public interface CfscriptTokenTypes {
  ...
  */
  ...
  IElementType THROW_KEYWORD = new CfmlElementType("THROW_KEYWORD");
  ...
  IElementType FOR_IN_KEYWORD = new CfmlElementType("FOR_IN_KEYWORD");
  ...
  IElementType BOOLAEN_TYPE = new CfmlElementType("BOOLAEN_TYPE");
  ...
  TokenSet TYPE_KEYWORDS = TokenSet
    .create(ANY_TYPE, ARRAY_TYPE, BINARY_TYPE, BOOLAEN_TYPE, DATE_TYPE, GUID_TYPE, NUMERIC_TYPE, QUERY_TYPE, STRING_TYPE, STRUCT_TYPE,
  ...
  TokenSet KEYWORDS = TokenSet
    .create(SCOPE_KEYWORD, DEFAULT_KEYWORD, FUNCTION_KEYWORD, SWITCH_KEYWORD, CASE_KEYWORD, DO_KEYWORD, IF_KEYWORD, TRY_KEYWORD,
            CATCH_KEYWORD, ELSE_KEYWORD, VAR_KEYWORD, WHILE_KEYWORD, CONTINUE_KEYWORD, FOR_KEYWORD, FOR_IN_KEYWORD, RETHROW_KEYWORD, RETURN_KEYWORD,
            ...
            REQUIRED_KEYWORD,
            ANY_TYPE, ARRAY_TYPE, BINARY_TYPE, BOOLAEN_TYPE, DATE_TYPE, GUID_TYPE, NUMERIC_TYPE, QUERY_TYPE, STRING_TYPE, STRUCT_TYPE,
            UUID_TYPE, VARIABLENAME_TYPE, VOID_TYPE, XML_TYPE,
            IMPORT_KEYWORD, ACTION_NAME);
  TokenSet ONE_WORD_KEYWORDS = TokenSet.create(
    BREAK_KEYWORD, ABORT_KEYWORD, DEFAULT_KEYWORD, FUNCTION_KEYWORD, SWITCH_KEYWORD, CASE_KEYWORD,
    DO_KEYWORD, IF_KEYWORD, TRY_KEYWORD, CATCH_KEYWORD, FINALLY_KEYWORD, ELSE_KEYWORD, VAR_KEYWORD,
    FOR_KEYWORD, CONTINUE_KEYWORD, RETURN_KEYWORD, WHILE_KEYWORD, COMPONENT_KEYWORD, INTERFACE_KEYWORD,
    PAGEENCODING_KEYWORD, ABORT_KEYWORD, INCLUDE_KEYWORD, PUBLIC_KEYWORD, PRIVATE_KEYWORD, REMOTE_KEYWORD,
    PACKAGE_KEYWORD, REQUIRED_KEYWORD, ANY_TYPE, ARRAY_TYPE, BINARY_TYPE, BOOLAEN_TYPE, DATE_TYPE,
    GUID_TYPE, NUMERIC_TYPE, QUERY_TYPE, STRING_TYPE, STRUCT_TYPE, UUID_TYPE, VARIABLENAME_TYPE,
    VOID_TYPE, XML_TYPE, IMPORT_KEYWORD, BOOLEAN, IN_L, MOD_L, NOT_L, AND_L, OR_L, XOR_L, NOT_XOR_L,
    IMP_L, EQ_L, NEQ_L, CONTAINS_L, NOT_CONTAINS_L, GT_L, LT_L, GE_L, LE_L);
