...
// based on https://github.com/withastro/language-tools/blob/1172836634269d4763385c2e0a8622a614a29bea/packages/vscode/scripts/build.mjs

const path = require('path');
const fs = require('fs');

// .js is here, so it's easier to Find in Files
const packageRelativePath = "dist/index.js"
    .replace(".js", "");

const ownPackageJson = require('@astrojs/ts-plugin/package.json');
