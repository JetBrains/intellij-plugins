...
public class DartListPatternElementImpl extends DartPsiCompositeElementImpl implements DartListPatternElement {

  public DartListPatternElementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DartVisitor visitor) {
    visitor.visitListPatternElement(this);
  }
  ...
  @Override
  @Nullable
  public DartRestPattern getRestPattern() {
    return findChildByClass(DartRestPattern.class);
  }
