...
const Map<String, LibraryInfo> LIBRARIES = const <LibraryInfo> {
  ...
  "core": const LibraryInfo(
      "core/core.dart",
      dart2jsPatchPath: "../pkg/compiler/implementation/lib/core_patch.dart"),

  "coreimpl": const LibraryInfo(
      "coreimpl/coreimpl.dart",
      implementation: true,
      dart2jsPatchPath: "../pkg/compiler/implementation/lib/coreimpl_patch.dart"),
  ...
  "io": const LibraryInfo(
      "io/io_runtime.dart",
      category: "Server",
      dart2jsPath: "../pkg/compiler/implementation/lib/io.dart"),

  "isolate": const LibraryInfo(
      "isolate/isolate.dart",
      dart2jsPatchPath: "../pkg/compiler/implementation/lib/isolate_patch.dart"),
  ...
  "math": const LibraryInfo(
      "math/math.dart",
      dart2jsPatchPath: "../pkg/compiler/implementation/lib/math_patch.dart"),

  "mirrors": const LibraryInfo(
      "mirrors/mirrors.dart",
      dart2jsPath: "../pkg/compiler/implementation/lib/mirrors.dart"),
  ...
  "scalarlist": const LibraryInfo(
      ...
      category: "Server",
      dart2jsPatchPath: "../pkg/compiler/implementation/lib/scalarlist_patch.dart"),
  ...
  "_js_helper": const LibraryInfo(
      "../pkg/compiler/implementation/lib/js_helper.dart",
      category: "Internal",
      documented: false,
      platforms: DART2JS_PLATFORM),

  "_interceptors": const LibraryInfo(
      "../pkg/compiler/implementation/lib/interceptors.dart",
      category: "Internal",
      documented: false,
      platforms: DART2JS_PLATFORM),
};
