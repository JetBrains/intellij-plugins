...
<info textAttributesKey="DART_TOP_LEVEL_FUNCTION_DECLARATION"><info textAttributesKey="DART_TOP_LEVEL_FUNCTION_DECLARATION">foo5</info></info>(){
  yield <info textAttributesKey="DART_LOCAL_VARIABLE">a</info>;
  yield*<info textAttributesKey="DART_LOCAL_VARIABLE_ACCESS">a</info>*b;
  <info textAttributesKey="DART_KEYWORD">await</info> for(<info textAttributesKey="DART_LOCAL_VARIABLE">a</info> in <info textAttributesKey="DART_LOCAL_VARIABLE">a</info>);
  await <info textAttributesKey="DART_LOCAL_VARIABLE">c</info>;
}
