      ...
      ApplicationManager.getApplication().runReadAction(new Runnable() {
        ...
        public void run() {
          ...
          final VirtualFile vFile =
            myProject.isDisposed() ? null : LocalFileSystem.getInstance().findFileByPath(FileUtil.toSystemDependentName(file));
          ...
          problemsView.clearOldMessages(vFile, mySessionId);
          ...
          for (final AnalysisError analysisError : errors) {
            ...
            problemsView.addMessage(vFile, analysisError, mySessionId);
          }
        }
      });
    }
