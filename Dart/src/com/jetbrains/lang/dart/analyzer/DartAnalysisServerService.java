...
public final class DartAnalysisServerService implements Disposable {
  ...
  @Nullable
  public Pair<String, SourceChange> completion_getSuggestionDetails(@NotNull final VirtualFile file,
                                                                    final int id,
                                                                    final String label,
                                                                    final int _offset) {
    final AnalysisServer server = myServer;
  ...
  @Nullable
  public Pair<List<CompletionSuggestion>, List<RuntimeCompletionExpression>> execution_getSuggestions(@NotNull final String code,
                                                                                                      final int offset,
