...
public class DartAnalysisServerService implements Disposable {
  ...
  private static final long EDIT_DARTFIX_TIMEOUT = TimeUnit.SECONDS.toMillis(10);
  ...
  @Nullable
  public List<SourceFileEdit> edit_dart_fix_non_nullable(@NotNull final VirtualFile file) {
    return edit_dart_fix_non_nullable(Collections.singletonList(file));
  }

  @Nullable
  public List<SourceFileEdit> edit_dart_fix_non_nullable(@NotNull final List<VirtualFile> files) {
  ...
  private List<SourceFileEdit> edit_dartfix(@NotNull final List<VirtualFile> files, @NotNull final List<String> includedFixes) {
    ...
    final CountDownLatch latch = new CountDownLatch(1);
    server.edit_dartfix(filePaths, includedFixes, false, new SmartList<>(), new DartfixConsumer() {
      @Override
