...
public class DartAnalysisServerSettingsForm {
  ...
  private void createUIComponents() {
    myDartSettingsHyperlink = new HoverHyperlinkLabel(DartBundle.message("analysis.server.settings.sdk.settings"));
  ...
  public void addListener(@NotNull final ServerSettingsListener serverSettingsListener) {
    final ActionListener listener = e -> serverSettingsListener.settingsChanged();

    packageScopedAnalysisCheckbox.addActionListener(listener);
  }
