...
public class DartSubtypesHierarchyTreeStructure extends HierarchyTreeStructure {
  ...
  protected final Object[] buildChildren(@NotNull final HierarchyNodeDescriptor descriptor) {
    final Object element = ((DartTypeHierarchyNodeDescriptor)descriptor).getPsiClass();
    if (!(element instanceof DartClass)) return ArrayUtil.EMPTY_OBJECT_ARRAY;
  ...
  private boolean doesDirectlySubclass(final DartClass dartClass, final DartClass subClass) {
