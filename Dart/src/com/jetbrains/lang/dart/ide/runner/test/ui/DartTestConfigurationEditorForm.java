...
import com.jetbrains.lang.dart.ide.runner.test.DartTestLocationProvider;
        ...
        PsiElementProcessor<PsiElement> collector = new PsiElementProcessor<PsiElement>() {
          ...
          public boolean execute(@NotNull final PsiElement element) {
            if (element instanceof DartCallExpression) {
              ...
              if (DartTestRunConfigurationProducer.isTest(expression)) {
                myTests.add(DartTestLocationProvider.getTestLabel(expression));
              }
              else if (DartTestRunConfigurationProducer.isGroup(expression)) {
