...
public class DartServerCompletionContributor extends CompletionContributor {
             ...
             protected void addCompletions(@NotNull final CompletionParameters parameters,
               ...
               das.addCompletions(file, completionId, (replacementOffset, replacementLength, suggestion) -> {
                 ...
                 for (AvailableSuggestion suggestion : suggestionSet.getItems()) {
                   ...
                   CompletionSuggestion completionSuggestion = createCompletionSuggestionFromAvailableSuggestion(
                     suggestion, suggestionSet, includedSet.getRelevance(), includedRelevanceTags);
                   LookupElementBuilder lookupElement = createLookupElement(
                     project, completionSuggestion, suggestionSet.getId(), targetFile, true, suggestionSet.getUri());
  ...
  @NotNull
  private static CompletionSuggestion createCompletionSuggestionFromAvailableSuggestion(
      @NotNull final AvailableSuggestion suggestion,
      @NotNull final AvailableSuggestionSet suggestionSet,
      final int suggestionSetRelevance,
      Map<String, IncludedSuggestionRelevanceTag> includedSuggestionRelevanceTags) {
    int relevance = suggestionSetRelevance;
    for (String tag : suggestion.getRelevanceTags()) {
      if (!includedSuggestionRelevanceTags.containsKey(tag)) {
        continue;
      }
    ...
    List<String> suggestionTags = suggestion.getRelevanceTags();
