...
public class DartTestEventsConverterTest extends BaseSMTRunnerTestCase {
  ...
  public void testLoadFailure() {
    String[] events = {
      "{'test':{'id':0,'name':'loading test/formatter_test.dart','groupIDs':[],'metadata':{'skip':false,'skipReason':null}},'type':'testStart','time':0}\n",
      "{'testID':0,'error':'Failed to load \\\"test/formatter_test.dart\\\":\\nline 117 pos 69','stackTrace':'','type':'error','time':497}\n",
      "{'testID':0,'error':'2nd failure message','stackTrace':'','type':'error','time':497}\n",
      "{'testID':0,'error':'3rd failure message','stackTrace':'3rd stack trace','type':'error','time':497}\n",
      ...
      "{'testID':1,'error':'Failed to load \\\"another_bad_test.dart\\\"','stackTrace':'some stack','type':'error','time':497}\n",
  ...
  public void testSetUpAllFailure() {
    String[] events = {
      ...
      "{'testID':3,'error':'fail','stackTrace':'test/next_test.dart 4:30  main.<fn>','type':'error','time':389}\n",
