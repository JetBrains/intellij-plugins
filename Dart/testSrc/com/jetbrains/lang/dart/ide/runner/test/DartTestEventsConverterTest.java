...
public class DartTestEventsConverterTest extends BaseSMTRunnerTestCase {
  ...
  private static final String[] SampleSignals = {
    ...
    "finish line endings uses given line ending",
    "start line endings fails once",
    "print line endings fails once \nsomething\n",
    "fail line endings fails once false",
    "print line endings fails once package:test                    fail\ntest/formatter_test.dart 108:7  main.<fn>.<fn>\n",
    "start line endings fails twice",
    "print line endings fails twice \nmessage\n",
    "fail line endings fails twice true",
    "print line endings fails twice dart:core                       NoSuchMethodError._throwNew\ntest/formatter_test.dart 112:7  main.<fn>.<fn>\n",
    "start line endings fails thrice",
    "fail line endings fails thrice false",
    "print line endings fails thrice package:test                    expect\ntest/formatter_test.dart 115:7  main.<fn>.<fn>\n",
    "start line endings infers \\r\\n if the first newline uses that",
    "skip line endings infers \\r\\n if the first newline uses that Test ignored.",
    "start line endings infers \\n if the first newline uses that",
    "skip line endings infers \\n if the first newline uses that just because",
    "start line endings defaults to \\n if there are no newlines",
    "finish line endings defaults to \\n if there are no newlines",
    "start line endings handles Windows line endings in multiline strings",
    "finish line endings handles Windows line endings in multiline strings",
    // @formatter:on
  };
