...
public class DartTypeHierarchyTest extends HierarchyViewTestBase {
  ...
  protected String getBasePath() {
    return DartTestUtils.BASE_TEST_DATA_PATH + FileUtil.toSystemDependentName("/hierarchy/type/") + getTestName(false);
  }

  protected String getTestDataPath() {
    return ""; // return DartTestUtils.BASE_TEST_DATA_PATH + getBasePath();
  }
