...
public class DartStyleTest extends FormatterTestCase {
  ...
  static {
    ...
    KNOWN_TO_FAIL.add("splitting/lists.stmt:44  nested split list");
    KNOWN_TO_FAIL.add("splitting/lists.stmt:61  force multi-line because of contained block");
    KNOWN_TO_FAIL.add("splitting/lists.stmt:76  dangling comma");
    KNOWN_TO_FAIL.add("splitting/lists.stmt:80  dangling comma multiline");
    ...
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:102  unsplit trailing args");
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:109  split before trailing args");
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:118  split in middle of trailing args");
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:12  nothing but map args does not nest");
    ...
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:193  don't nest because of nested 1-arg fn");
    ...
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:209  don't nest because of nested 1-arg method call");
    ...
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:38  leading maps do not nest");
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:50  arg between maps forces nesting");
    KNOWN_TO_FAIL.add("splitting/map_arguments.stmt:64  unsplit leading args");
    ...
    KNOWN_TO_FAIL.add("splitting/maps.stmt:39  nested split map");
    KNOWN_TO_FAIL.add("splitting/maps.stmt:53  force multi-line because of contained block");
    KNOWN_TO_FAIL.add("splitting/maps.stmt:63  containing comments");
    KNOWN_TO_FAIL.add("splitting/maps.stmt:70  const");
    KNOWN_TO_FAIL.add("splitting/maps.stmt:81  dangling comma multiline");
    ...
    KNOWN_TO_FAIL.add("splitting/mixed.stmt:118  list at end of method chain");
