...
enum class Lang(val displayName: String, val shortCode: String, private val className: String, val remote: RemoteLangDescriptor,
  ...
  BRITISH_ENGLISH("English (GB)", "en", "BritishEnglish", RemoteLangDescriptor.ENGLISH,
                  GraziBundle.langConfig("en.rules.enabled"), GraziBundle.langConfig("en.rules.disabled"),
                  GraziBundle.langConfig("en.categories.disabled")),
  ...
  GERMANY_GERMAN("German (Germany)", "de", "GermanyGerman", RemoteLangDescriptor.GERMAN,
                 disabledCategories = GraziBundle.langConfig("de.categories.disabled")),
