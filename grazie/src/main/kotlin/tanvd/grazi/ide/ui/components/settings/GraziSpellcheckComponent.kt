...
class GraziSpellcheckComponent {
  private val checkbox = JBCheckBox(msg("grazi.ui.settings.spellcheck.enable.text"))
  ...
  val component = wrapWithComment(checkbox, msg("grazi.ui.settings.spellcheck.enable.note"))
}
