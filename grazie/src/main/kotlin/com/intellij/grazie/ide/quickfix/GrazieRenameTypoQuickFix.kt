...
open class GrazieRenameTypoQuickFix(private val typo: Typo) : RefactoringQuickFix, Iconable, PriorityAction {
  companion object {
    private val logger = LoggerFactory.getLogger(GrazieRenameTypoQuickFix::class.java)
  }

  override fun getFamilyName() = msg("grazie.quickfix.renametypo.family")

  override fun getName() = msg("grazie.quickfix.renametypo.text", (typo.info.match.shortMessage.trimToNull()
