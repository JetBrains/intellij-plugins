...
public final class ProtoeditorCoreIcons {
  ...
  /** 16x16 */ public static final @NotNull Icon ProtoFile = load("icons/protoFile.png", "icons/newui/protoFile.svg", 0, 1);
  /** 16x16 */ public static final @NotNull Icon ProtoMessage = load("icons/protoMessage.png", "icons/newui/protoMessage.svg", 0, 1);
}
