...
public class NotClashingFieldUser {

  public int test(Foo x) {
    // EXPECT-NEXT: not_clashing_field.proto / Foo.NotClashingField
    return x./* caretAfterThis */ getNotClashingField();
  }
}
