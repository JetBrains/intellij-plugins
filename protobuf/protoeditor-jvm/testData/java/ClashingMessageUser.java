...
public class ClashingMessageUser {

  // EXPECT-NEXT: clashing_message.proto / ClashingMessage
  public /* caretAfterThis */ ClashingMessage test(ClashingMessage.Builder x) {
