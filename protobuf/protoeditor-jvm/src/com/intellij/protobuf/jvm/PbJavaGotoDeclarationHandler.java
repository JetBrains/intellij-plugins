...
public class PbJavaGotoDeclarationHandler implements GotoDeclarationHandler {
  ...
  private List<PsiElement> findMatchingElements(PbFile file, PbJavaGotoDeclarationContext context) {
    ...
    List<NameMatcher> nameMatchers =
        NameGeneratorSelector.selectForFile(file)
            .stream()
            .map(generator -> generator.toNameMatcher(context))
