 ...
 * span into one [MdxTokenTypes.JSX_BLOCK_CONTENT] token, so the editor highlighter's JS/JSX layer covers
...
internal class MdxInlineHighlightingLexer : LexerBase() {
  ...
  companion object {
    private val JSX_BLOCK_CONTENT: IElementType = MarkdownElementType.platformType(MdxTokenTypes.JSX_BLOCK_CONTENT)
