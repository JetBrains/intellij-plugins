...
internal class MdxCodeFenceCompletionIndentRestorer : LookupManagerListener {
  override fun activeLookupChanged(oldLookup: Lookup?, newLookup: Lookup?) {
    ...
    if (InjectedLanguageManager.getInstance(project).getTopLevelFile(lookup.psiFile ?: return) !is MdxFile) return
  ...
  private fun restoreFenceIndent(project: Project, hostEditor: Editor) {
    ...
    val element = hostFile.findElementAt((caret - 1).coerceAtLeast(0)) ?: return
