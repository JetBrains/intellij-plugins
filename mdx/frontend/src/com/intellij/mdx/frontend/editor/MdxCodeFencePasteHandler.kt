...
import org.intellij.plugin.mdx.editor.MdxCodeFenceSandbox
 ...
 * the MDX formatting model reports the fence as a leaf. The clipboard text
 ...
 *
 * Unlike the MDX Enter handler, this is not an
