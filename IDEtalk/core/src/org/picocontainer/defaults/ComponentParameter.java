...
public final class ComponentParameter implements Parameter {
  ...
  public ComponentAdapter resolveAdapter(PicoContainer container, @Nullable ComponentAdapter adapter, Class expectedType) {
    ComponentAdapter result = getTargetAdapter((DefaultPicoContainer)container, expectedType, adapter);
    if (result == null) {
      return null;
    }
  ...
  private ComponentAdapter getTargetAdapter(DefaultPicoContainer container, Class expectedType, @Nullable ComponentAdapter excludeAdapter) {
