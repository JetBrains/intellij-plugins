...
public final class CollectionComponentParameter implements Parameter {
  ...
  public Object resolveInstance(PicoContainer container, ComponentAdapter adapter, Class expectedType) {
    ...
    if (collectionType != null) {
      Map<Object, ComponentAdapter> adapterMap = getMatchingComponentAdapters((DefaultPicoContainer)container, adapter, componentKeyType, getValueType(expectedType));
  ...
  public boolean isResolvable(PicoContainer container, ComponentAdapter adapter, Class expectedType) {
    ...
    return collectionType != null &&
           (emptyCollection || getMatchingComponentAdapters((DefaultPicoContainer)container, adapter, componentKeyType, valueType).size() > 0);
  }
  ...
  public void verify(PicoContainer container, ComponentAdapter adapter, Class expectedType) {
    final Class collectionType = getCollectionType(expectedType);
      ...
      final Class valueType = getValueType(expectedType);
      final Collection componentAdapters = getMatchingComponentAdapters((DefaultPicoContainer)container, adapter, componentKeyType, valueType).values();
   ...
   */
  private static Map<Object, ComponentAdapter> getMatchingComponentAdapters(DefaultPicoContainer container,
                                                                            ComponentAdapter adapter,
                                                                            Class<?> keyType,
                                                                            Class<?> valueType) {
    Map<Object, ComponentAdapter> adapterMap = new LinkedHashMap<>();
    DefaultPicoContainer parent = container.getParent();
    if (parent != null) {
