...
public class PerforceUnversionedTracker {
  ...
  private final Set<VirtualFile> myUnversionedFiles = Collections.newSetFromMap(new ConcurrentHashMap<>());
  private final Set<VirtualFile> myIgnoredFiles = Collections.newSetFromMap(new ConcurrentHashMap<>());
