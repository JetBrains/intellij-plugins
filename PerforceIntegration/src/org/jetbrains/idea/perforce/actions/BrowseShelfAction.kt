 ...
 * @author peter
 */
class BrowseShelfAction : DumbAwareAction(PerforceBundle.messagePointer("shelf.browse")) {
  ...
  override fun actionPerformed(e: AnActionEvent) {
    browseShelf(e.project!!, getShelvedChanges(e.project!!, e))
  }
  ...
  companion object {
    ...
    @JvmStatic fun groupByChangeList(selected: List<ShelvedChange>): MultiMap<Pair<P4Connection, Long>, String> {
    ...
    @JvmStatic fun deleteFromShelf(paths: MultiMap<Pair<P4Connection, Long>, String>, project: Project) {
      for ((pair, specs) in paths.entrySet()) {
        val (connection, changeList) = pair
        try {
    ...
    @JvmStatic fun deleteFromShelf(changes: List<ShelvedChange>, project: Project) {
