...
function Tree(configFilePath) {
    this.configFileNode = new TestSuiteNode(this, 1, 0, path.basename(configFilePath), 'config');
    this.nextId = 2;
}
...
TestNode.prototype.getFinishCommandName = function() {
    switch (this.status) {
        case 0: return 'testFinished';
        case 1: return 'testFailed';
        case 2: return 'testFailed';
        default: throw Error("Unexpected status: " + JSON.stringify(this.status));
    }
};
