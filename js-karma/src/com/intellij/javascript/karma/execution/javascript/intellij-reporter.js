...
var BaseReporter = require(path.join(config.karmaPackageDir, 'lib/reporters/Base.js'));
...
function IntellijReporter(formatError) {
    ...
    this.onRunStart = function(browsers) {
        tree = new Tree(config.configFilePath);
        tree.configFileNode.writeStartMessage();
    };
