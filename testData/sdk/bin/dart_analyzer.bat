...
java %EXTRA_JVMARGS% %DART_JVMARGS% -ea -classpath "%DART_ANALYZER_LIBS%\dart_analyzer.jar;%DART_ANALYZER_LIBS%\args4j\2.0.12\args4j-2.0.12.jar;%DART_ANALYZER_LIBS%\guava\r13\guava-13.0.1.jar;%DART_ANALYZER_LIBS%\json\r2_20080312\json.jar" ^
  com.google.dart.compiler.DartCompiler %DART_SDK% %*

rem exec java $EXTRA_JVMARGS $DART_JVMARGS -ea -classpath "%DART_ANALYZER_LIBS%\dart_analyzer.jar;%DART_ANALYZER_LIBS%\args4j\2.0.12\args4j-2.0.12.jar;%DART_ANALYZER_LIBS%\guava\r13\guava-13.0.1.jar;%DART_ANALYZER_LIBS%\json\r2_20080312\json.jar" \
