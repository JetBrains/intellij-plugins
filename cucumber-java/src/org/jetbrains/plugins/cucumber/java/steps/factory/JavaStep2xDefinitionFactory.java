...
public class JavaStep2xDefinitionFactory extends JavaStepDefinitionFactory {
  @Override
  public AbstractJavaStepDefinition buildStepDefinition(@NotNull PsiElement element, @NotNull String annotationClassName) {
    return new JavaStep2xDefinition(element, annotationClassName);
  }
}
