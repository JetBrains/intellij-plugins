...
import com.intellij.lang.javascript.linter.tslint.execution.TsLintProcessListener;
...
public class TsLintOutputParsingTest {
  ...
  public void testParseExample() throws Exception {
    ...
    final TsLintProcessListener parser = new TsLintProcessListener("test", false);
