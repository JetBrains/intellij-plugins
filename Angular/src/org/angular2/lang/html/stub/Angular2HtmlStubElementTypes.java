...
public interface Angular2HtmlStubElementTypes {
  ...
  JSStubElementType<JSVariableStub<JSVariable>, JSVariable> REFERENCE_VARIABLE = new Angular2HtmlVariableElementType(Kind.REFERENCE);
  JSStubElementType<JSVariableStub<JSVariable>, JSVariable> LET_VARIABLE = new Angular2HtmlVariableElementType(Kind.LET);
