...
@Component({
    ...
    template: `<input [formControl]="formGroup.controls.text" 
                      [formControlName]="<error descr="Type FormControl<CustomLinkData[\"text\"]> is not assignable to type string | number | null  Type FormControl<CustomLinkData[\"text\"]> is not assignable to type number    Type FormControl<CustomLinkData[\"text\"]> is not assignable to type string">formGroup.controls.text</error>">`
})
