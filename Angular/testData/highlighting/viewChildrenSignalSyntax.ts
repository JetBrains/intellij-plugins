...
export class <symbolName descr="classes//exported class">TestComponent</symbolName> {
  <warning descr="Unused field area1"><symbolName descr="ng-signal">area1</symbolName></warning> = <symbolName descr="identifiers//exported function">viewChild</symbolName>("<symbolName descr="NG.VARIABLE">area</symbolName>");
  <warning descr="Unused field area1a"><symbolName descr="ng-signal">area1a</symbolName></warning> = <symbolName descr="identifiers//exported function">viewChild</symbolName><<symbolName descr="classes//exported class">ElementRef</symbolName>>("<symbolName descr="NG.VARIABLE">area</symbolName>");

  <warning descr="Unused field area1req"><symbolName descr="ng-signal">area1req</symbolName></warning> = <symbolName descr="identifiers//exported function">viewChild</symbolName>.<symbolName descr="instance method">required</symbolName><<symbolName descr="classes//exported class">ElementRef</symbolName>>("<symbolName descr="NG.VARIABLE">areaReq</symbolName>");
  <warning descr="Unused field area1reqA"><symbolName descr="ng-signal">area1reqA</symbolName></warning> = <symbolName descr="identifiers//exported function">viewChild</symbolName>.<symbolName descr="instance method">required</symbolName>("<symbolName descr="NG.VARIABLE">areaReq</symbolName>");
  ...
  <warning descr="Unused field badArea1"><symbolName descr="ng-signal">badArea1</symbolName></warning> = <symbolName descr="identifiers//exported function">viewChild</symbolName><<symbolName descr="classes//exported class">ElementRef</symbolName>>("<warning descr="Unrecognized name">badArea</warning>");
