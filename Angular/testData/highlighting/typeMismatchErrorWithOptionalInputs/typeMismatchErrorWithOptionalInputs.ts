...
@Component({
             ...
             template: `
               <div>
                 ...
                 <app-test <error descr="TS2322: Type 'string | undefined' is not assignable to type 'string'.
  Type 'undefined' is not assignable to type 'string'.">[item2]</error>="myItem1"></app-test>
               ...
               <div>
                 ...
                 <app-test <error descr="TS2322: Type 'string | undefined' is not assignable to type 'string'.
  Type 'undefined' is not assignable to type 'string'.">[item2]</error>="myItem2"></app-test>
               ...
               <div>
                 ...
                 <app-test <error descr="TS2322: Type 'string | undefined' is not assignable to type 'string'.
  Type 'undefined' is not assignable to type 'string'.">[item2]</error>="myItem3"></app-test>
