...
export declare class ModalCmp {
    ...
    constructor(_cfr: ComponentFactoryResolver, _renderer: Renderer, _navParams: NavParams, _viewCtrl: ViewController, gestureCtrl: GestureController, moduleLoader: ModuleLoader);
    ionViewPreLoad(): void;
    /** @hidden */
