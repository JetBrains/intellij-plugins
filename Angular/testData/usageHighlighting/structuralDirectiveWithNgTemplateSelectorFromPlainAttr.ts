...
@Directive({
             standalone: true,
             selector: 'ng-template[<usage>appTableHead</usage>]'
           })
...
@Component({
 ...
 template: `
    <app-table [data]="persons">
      <ng-template [<usage>appTableHead</usage>]="12">
        <td scope="col" class="py-3 px-6">Firstname</td>
      </ng-template>
      <ng-template [<usage>appTableHead</usage>] >
        <td scope="col" class="py-3 px-6">Firstname</td>
      </ng-template>
      <ng-template <usage>app<caret>TableHead</usage>>
        <td scope="col" class="py-3 px-6">Firstname</td>
      </ng-template>
