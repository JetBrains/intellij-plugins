...
class Angular2GotoRelatedTest : Angular2CodeInsightFixtureTestCase() {
  @Parameterized.Parameter
  @JvmField
  var myTestDir: String? = null
  override fun getTestDataPath(): String {
    return Angular2TestUtil.getBaseTestDataPath() + "navigation/related/" + myTestDir
  }
  ...
  companion object {
    ...
    fun testNames(klass: Class<*>): List<String> {
      return StreamEx.of(*File(Angular2TestUtil.getBaseTestDataPath(), "navigation/related").listFiles())
