...
import {<symbolName descr="classes//exported class">FormControl</symbolName>, <symbolName descr="classes//exported class">FormGroup</symbolName>, <symbolName descr="classes//exported class">FormArray</symbolName>} <info descr="null">from</info> '@angular/forms';
...
export class <symbolName descr="classes//exported class">NestedFormGroupComp</symbolName> {
  <symbolName descr="instance field">form</symbolName> = new <symbolName descr="classes//exported class">FormGroup</symbolName>({
     <symbolName descr="instance field">first</symbolName>: new <symbolName descr="classes//exported class">FormArray</symbolName>([new <symbolName descr="classes//exported class">FormControl</symbolName>('Foo'), new <symbolName descr="classes//exported class">FormControl</symbolName>('Foo')]),
     <symbolName descr="instance field">group</symbolName>: new <symbolName descr="classes//exported class">FormGroup</symbolName>({
       <symbolName descr="instance field">name</symbolName>: new <symbolName descr="classes//exported class">FormControl</symbolName>(),
       <symbolName descr="instance field">members</symbolName>: new <symbolName descr="classes//exported class">FormArray</symbolName>([new <symbolName descr="classes//exported class">FormControl</symbolName>('Foo'), new <symbolName descr="classes//exported class">FormControl</symbolName>('Foo')])
     }),
  });
