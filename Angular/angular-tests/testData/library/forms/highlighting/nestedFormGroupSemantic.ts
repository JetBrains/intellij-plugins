...
import {<symbolName descr="classes//exported class">FormControl</symbolName>, <symbolName descr="classes//exported class">FormGroup</symbolName>, <symbolName descr="classes//exported class">Validators</symbolName>} <info descr="null">from</info> '@angular/forms';
...
export class <symbolName descr="classes//exported class">NestedFormGroupComp</symbolName> {
  <symbolName descr="instance field">form</symbolName> = new <symbolName descr="classes//exported class">FormGroup</symbolName>({
     <symbolName descr="instance field">name</symbolName>: new <symbolName descr="classes//exported class">FormGroup</symbolName>({
       <symbolName descr="instance field">first</symbolName>: new <symbolName descr="classes//exported class">FormControl</symbolName>('Foo'),
       <symbolName descr="instance field">last</symbolName>: new <symbolName descr="classes//exported class">FormControl</symbolName>('Bar'),
       <symbolName descr="instance field">foo</symbolName>: new <symbolName descr="classes//exported class">FormGroup</symbolName>({
         <symbolName descr="instance field">bar</symbolName>: new <symbolName descr="classes//exported class">FormControl</symbolName>('Baz')
       })
     }),
     <symbolName descr="instance field">gender</symbolName>: new <symbolName descr="classes//exported class">FormControl</symbolName>(),
     <symbolName descr="instance field">address</symbolName>: new <symbolName descr="classes//exported class">FormGroup</symbolName>({}),
     <symbolName descr="instance field">email</symbolName>: new <symbolName descr="classes//exported class">FormControl</symbolName>(),
  });
