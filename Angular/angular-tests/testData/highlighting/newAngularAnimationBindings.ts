...
<symbolName descr="decorator">@</symbolName><symbolName descr="decorator">Component</symbolName>({
  ...
  <symbolName descr="instance field">template</symbolName>: `<inject descr="null">
        ...
        @if (<symbolName descr="ng-signal">isShown</symbolName>()) {
            <div class="enter-container" [animate.enter]="<symbolName descr="ng-signal">enterClass</symbolName>()">
                <p>The box is entering.</p>
            </div>
            <div class="enter-container" [animate.leave]="<symbolName descr="ng-signal">enterClass</symbolName>()">
                <p>The box is entering.</p>
            </div>
            ...
            <div class="enter-container" [animate.enter]="<error descr="TS2339: Property 'foo' does not exist on type 'Enter'.">foo</error>">
              <p>The box is entering.</p>
            </div>
            <div class="enter-container" [animate.leave]="<error descr="TS2339: Property 'foo' does not exist on type 'Enter'.">foo</error>">
              <p>The box is entering.</p>
            </div>
            <div class="enter-container" <error descr="TS2322: Type 'boolean' is not assignable to type 'string | string[]'.">[animate.enter]</error>="true">
              <p>The box is entering.</p>
            </div>
            <div class="enter-container" <error descr="TS2322: Type 'number' is not assignable to type 'string | string[]'.">[animate.leave]</error>="123">
              <p>The box is entering.</p>
            </div>
        }
    </inject>`,
...
export class <symbolName descr="classes//exported class">Enter</symbolName> {
  ...
  <symbolName descr="ng-signal">enterClass</symbolName> = <symbolName descr="identifiers//exported function">signal</symbolName>('enter-animation');
}