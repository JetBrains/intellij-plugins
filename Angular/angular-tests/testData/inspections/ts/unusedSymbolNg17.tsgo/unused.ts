...
export class Home {
    ...
    private <error descr="TS2564: Property 'privateUsedField' has no initializer and is not definitely assigned in the constructor.">privateUsedField</error>: string;
