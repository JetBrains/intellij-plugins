  ...
  sourceFileUpdated(ts, snapshot, ctx, transpiledTemplate) {
    ...
    if (transpiledTemplate) {
      ...
      if (!getNormalizedSnapshotText(transpiledTemplate.snapshot).startsWith(sourceText) || sourceText !== transpiledTemplate.sourceCode[ts.server.toNormalizedPath(this.fileName)]) {
        ...
        var _a, _b;
        return getNormalizedSnapshotText((_a = ctx.getAssociatedScript(mapping.fileName)) == null ? void 0 : _a.snapshot) !== ((_b = transpiledTemplate == null ? void 0 : transpiledTemplate.sourceCode) == null ? void 0 : _b[ts.server.toNormalizedPath(mapping.fileName)]);
      })) {
        templateInSync = false;
      }
    }
