...
var AngularVirtualCode = class {
  ...
  sourceFileUpdated(snapshot, _languageId) {
    ...
    if (this.transpiledTemplate) {
      ...
      if (!getNormalizedSnapshotText(this.transpiledTemplate.snapshot).startsWith(sourceText) || sourceText !== this.transpiledTemplate.sourceCode[this.normalizeId(this.fileName)]) {
        templateInSync = false;
      } else if (this.transpiledTemplate.mappings.find((mapping) => {
        var _a, _b, _c;
        return getNormalizedSnapshotText((_a = this.ctx.getAssociatedScript(mapping.fileName)) == null ? void 0 : _a.snapshot) !== ((_c = (_b = this.transpiledTemplate) == null ? void 0 : _b.sourceCode) == null ? void 0 : _c[this.normalizeId(mapping.fileName)]);
      })) {
        templateInSync = false;
      }
    }
