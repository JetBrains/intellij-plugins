...
function loadLanguagePlugins(ts, info) {
    ...
    return {
        ...
        setup(language) {
            (0, decorateLanguageService_1.decorateIdeLanguageServiceExtensions)(language, info.languageService);
            (0, decorateLanguageService_1.decorateNgLanguageServiceExtensions)(language, info.languageService);
        }
    };
}
