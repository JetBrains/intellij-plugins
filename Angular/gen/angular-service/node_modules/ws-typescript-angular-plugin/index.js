      ...
      if (!transformedDiagnostics.has(diagnostic)) {
        ...
        if (diagnostic.file !== void 0 && diagnostic.start !== void 0 && diagnostic.length !== void 0) {
          ...
          if (serviceScript) {
            ...
            }, (data) => (0, language_core_1.shouldReportDiagnostics)(data, String(diagnostic.source), String(diagnostic.code)))) != null ? _a : [];
          ...
          create(info) {
            if (!exports2.decoratedLanguageServices.has(info.languageService) && !exports2.decoratedLanguageServiceHosts.has(info.languageServiceHost)) {
              ...
              const language = (0, language_core_1.createLanguage)([
                ...
                var _a, _b;
                let snapshot = (_a = info.project.getScriptInfo(fileName)) == null ? void 0 : _a.getSnapshot();
                if (!snapshot) {
                  info.project.getScriptVersion(fileName);
                  snapshot = (_b = info.project.getScriptInfo(fileName)) == null ? void 0 : _b.getSnapshot();
                }
                if (snapshot) {
...
var ngGetGeneratedElementTypeHandler = (ts, _session, projectService, request) => {
  ...
  )) != null ? _c : { responseRequired: true, response: void 0 };
};
