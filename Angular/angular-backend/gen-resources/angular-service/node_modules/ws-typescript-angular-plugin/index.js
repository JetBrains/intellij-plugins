...
function ngTranspiledTemplateHandler(ts, session, projectService, request) {
  ...
  if (scriptInfo) {
    (_a = transpiledTemplate == null ? void 0 : transpiledTemplate.mappings) == null ? void 0 : _a.forEach((mapping) => {
      var _a2;
      ...
      if (mappingFileName.endsWith(".html")) {
        ...
        if (mappingScriptInfo) {
          (_a2 = scriptInfo == null ? void 0 : scriptInfo.containingProjects) == null ? void 0 : _a2.forEach((project) => {
