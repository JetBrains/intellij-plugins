...
import com.intellij.lang.javascript.completion.JSLookupPriority.KEYWORDS_PRIORITY
...
import com.intellij.lang.javascript.completion.JSLookupPriority.RELEVANT_NO_SMARTNESS_PRIORITY
import com.intellij.lang.javascript.completion.JSLookupPriority.TOP_LEVEL_SYMBOLS_FROM_OTHER_FILES
      ...
      return lookupElement.asSafely<PrioritizedLookupElement<*>>()
               ...
               ?.let {
                 it.withInsertHandler(
                   JSCompletionInsertHandlerFactory.getInstance().getImportInsertHandler(
