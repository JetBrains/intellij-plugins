...
class Angular2HtmlBlockSymbol : WebTypesSymbolBase() {
  ...
  val parameterPrefixes: List<Angular2BlockParameterPrefixSymbol>
    get() = getSymbols(NG_BLOCK_PARAMETER_PREFIXES, PolySymbolListSymbolsQueryParams.create(queryExecutor, true), PolySymbolQueryStack(this))
      .filterIsInstance<Angular2BlockParameterPrefixSymbol>()

  val implicitVariables: List<PolySymbol>
    get() = getSymbols(JS_SYMBOLS, PolySymbolListSymbolsQueryParams.create(queryExecutor, true), PolySymbolQueryStack(this))
