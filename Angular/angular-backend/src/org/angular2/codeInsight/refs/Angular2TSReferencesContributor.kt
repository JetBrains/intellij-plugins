...
fun isAngularUrlLiteral(expression: JSLiteralExpression) =
  STYLE_URL_PATTERN.accepts(expression) || TEMPLATE_URL_PATTERN.accepts(expression) || STYLE_URLS_PATTERN.accepts(expression)
