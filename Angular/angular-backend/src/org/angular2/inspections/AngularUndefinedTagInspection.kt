...
import org.angular2.codeInsight.Angular2HighlightingUtils.TextAttributesKind.HTML_TAG
  ...
  override fun visitXmlTag(holder: ProblemsHolder, tag: XmlTag) {
    ...
    holder.registerProblem(tagName,
                           Angular2Bundle.htmlMessage(
                             "angular.inspection.undefined-tag.message.out-of-scope",
                             tagName.text.withColor(HTML_TAG, tag)
                           ),
