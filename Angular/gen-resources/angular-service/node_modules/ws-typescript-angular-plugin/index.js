...
function decorateIdeLanguageServiceExtensions(language, languageService, unboundReverseMapper) {
  ...
  if (webStormGetElementType === void 0 || webStormGetTypeProperties === void 0 || webStormGetTypeProperty === void 0 || webStormGetSymbolType === void 0)
    return;
  ...
  languageService.webStormGetSymbolType = (options) => {
    return webStormGetSymbolType(__spreadProps(__spreadValues({}, options), {
      reverseMapper: unboundReverseMapper.bind(null, options.ts)
    }));
  };
  languageService.webStormGetTypeProperties = (options) => {
    return webStormGetTypeProperties(__spreadProps(__spreadValues({}, options), {
      reverseMapper: unboundReverseMapper.bind(null, options.ts)
    }));
  };
  languageService.webStormGetTypeProperty = (options) => {
    return webStormGetTypeProperty(__spreadProps(__spreadValues({}, options), {
      reverseMapper: unboundReverseMapper.bind(null, options.ts)
    }));
  };
}
