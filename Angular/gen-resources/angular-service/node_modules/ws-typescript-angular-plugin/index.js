...
function decorateIdeLanguageServiceExtensions(language, languageService, unboundReverseMapper) {
  ...
  languageService.webStormGetTypeProperty = (ts, typeId, propertyName, cancellationToken, _reverseMapper) => {
    return webStormGetTypeProperty(ts, typeId, propertyName, cancellationToken, unboundReverseMapper.bind(null, ts));
  };
  languageService.webStormGetCompletionSymbols = (ts, ls, fileName, position, cancellationToken, _reverseMapper) => {
