...
public final class MeteorSettings implements PersistentStateComponent<MeteorSettings> {
  ...
  @Override
  public @NotNull MeteorSettings getState() {
    return this;
  }
  ...
  public static @NotNull List<String> detectMeteorExecutablePaths() {
    var result = PathEnvironmentVariableUtil.findAll(METEOR_SIMPLE_NAME);
    return ContainerUtil.map(result, path -> path.toString());
  }
}
