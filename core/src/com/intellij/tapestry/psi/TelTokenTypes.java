...
public abstract class TelTokenTypes {
  ...
  public static final TelTokenType TAP5_EL_START = new TelTokenType("TAP5_EL_START");
  public static final TelTokenType TAP5_EL_END = new TelTokenType("TAP5_EL_END");
  public static final TelTokenType TAP5_EL_IDENTIFIER = new TelTokenType("TAP5_EL_IDENTIFIER");
  public static final TelTokenType TAP5_EL_DOT = new TelTokenType("TAP5_EL_DOT");
  public static final TelTokenType TAP5_EL_COLON = new TelTokenType("TAP5_EL_COLON");
  public static final TelTokenType TAP5_EL_COMMA = new TelTokenType("TAP5_EL_COMMA");
  public static final TelTokenType TAP5_EL_QUESTION_DOT = new TelTokenType("TAP5_EL_QUESTION_DOT");
  public static final TelTokenType TAP5_EL_RANGE = new TelTokenType("TAP5_EL_RANGE");
  public static final TelTokenType TAP5_EL_EXCLAMATION = new TelTokenType("TAP5_EL_EXCLAMATION");
  public static final TelTokenType TAP5_EL_LEFT_PARENTH = new TelTokenType("TAP5_EL_LEFT_PARENTH");
  public static final TelTokenType TAP5_EL_RIGHT_PARENTH = new TelTokenType("TAP5_EL_RIGHT_PARENTH");
  public static final TelTokenType TAP5_EL_LEFT_BRACKET = new TelTokenType("TAP5_EL_LEFT_BRACKET");
  public static final TelTokenType TAP5_EL_RIGHT_BRACKET = new TelTokenType("TAP5_EL_RIGHT_BRACKET");
