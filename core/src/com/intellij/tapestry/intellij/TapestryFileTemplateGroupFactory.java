...
public class TapestryFileTemplateGroupFactory implements FileTemplateGroupDescriptorFactory {
    ...
    public FileTemplateGroupDescriptor getFileTemplatesDescriptor() {
        FileTemplateGroupDescriptor root = new FileTemplateGroupDescriptor(TEMPLATE_GROUP_NAME, TapestryCoreIcons.Tapestry_logo_small);
        ...
        root.addTemplate(new FileTemplateDescriptor(TapestryConstants.COMPONENT_TEMPLATE_TEMPLATE_NAME,
                                                    TapestryCoreIcons.Tapestry_logo_small));
        ...
        root.addTemplate(new FileTemplateDescriptor(TapestryConstants.PAGE_TEMPLATE_TEMPLATE_NAME, TapestryCoreIcons.Tapestry_logo_small));
