...
class SwiftCompletionLesson(module: Module) : KLesson("swift.completions.basiccompletion", SwiftLessonsBundle.message("swift.editor.completion.name"), module, "Swift") {
