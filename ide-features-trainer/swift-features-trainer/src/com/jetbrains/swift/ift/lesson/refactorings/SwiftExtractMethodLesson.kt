...
class SwiftExtractMethodLesson(module: Module) : KLesson("swift.refactorings.extract.method", SwiftLessonsBundle.message("swift.refactoring.extract.method.name"), module, "Swift") {
