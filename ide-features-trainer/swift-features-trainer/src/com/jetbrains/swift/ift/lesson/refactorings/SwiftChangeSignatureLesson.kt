...
class SwiftChangeSignatureLesson(module: Module) : KLesson("swift.refactorings.change.signature", SwiftLessonsBundle.message("swift.refactoring.change.signature.name"), module, "Swift") {
