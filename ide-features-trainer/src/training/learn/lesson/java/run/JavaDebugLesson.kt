  ...
  override val lessonContent: LessonContext.() -> Unit = {
          ...
          override fun processStarted(debugProcess: XDebugProcess) {
            ...
            debugSession.addSessionListener(object : XDebugSessionListener {
              override fun sessionStopped() {
                ...
                if (activeToolWindow != null && !mayBeStopped && LessonManager.instance.currentLesson == this@JavaDebugLesson) {
                  LessonManager.instance.addRestoreNotification(TaskContext.RestoreNotification(
                    ...
                    CourseManager.instance.openLesson(activeToolWindow.project, this@JavaDebugLesson)
                  })
                }
              }
            }, lessonDisposable)
    ...
    task("Debugger.AddToWatch") {
      ...
      text("IDE has several ways to show values. For this step, we selected the call. Lets add it to <strong>Watches</strong>. " +
           "You can copy the expression into clipboard, use ${icon(
             AllIcons.General.Add)} button on the debug panel and paste copied text. " +
    ...
    task {
      ...
      text("In most cases you will want to skip argument calculating so Smart Step Into feature suggest by default the wrapping method." +
           ...
           "You can choose it by keyboard <raw_action>→</raw_action> and press ${action(
             "EditorEnter")} or you can click the call by mouse.")
      stateCheck {
