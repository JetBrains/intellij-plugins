...
public class PostCssColorsPage implements ColorSettingsPage {
  ...
  private static final AttributesDescriptor[] ATTRS = new AttributesDescriptor[]{
    ...
    new AttributesDescriptor(CssBundle.message("css.property.name.title"), PostCssSyntaxHighlighter.PROPERTY_NAME),
    new AttributesDescriptor(CssBundle.message("css.property.value.title"), PostCssSyntaxHighlighter.PROPERTY_VALUE),
