...
class MakeConfigurable(project: Project?) : Configurable {
  ...
  private val cygwinField = JBCheckBox(MakefileLangBundle.message("configurable.use.cygwin.checkbox"))
  ...
  override fun getDisplayName(): @Nls String = MakefileLangBundle.message("configurable.name")
  override fun apply() {
  ...
  override fun createComponent(): JComponent {
    ...
    if (SystemInfo.isWindows) {
      builder.addComponent(cygwinField)
    }
    return builder
