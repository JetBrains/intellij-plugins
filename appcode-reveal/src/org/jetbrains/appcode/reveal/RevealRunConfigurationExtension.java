...
import com.jetbrains.cidr.execution.AppCodeAppRunConfiguration;
import com.jetbrains.cidr.execution.AppCodeInstaller;
import com.jetbrains.cidr.execution.AppCodeRunConfiguration;
import com.jetbrains.cidr.execution.AppCodeRunConfigurationExtension;
...
public final class RevealRunConfigurationExtension extends AppCodeRunConfigurationExtension {
  ...
  public void patchCommandLine(@NotNull ExecutionEnvironment environment, @NotNull GeneralCommandLine cmdLine) {
    ...
    if (toInject != null) {
      ...
      PathEnvironmentVariableUtil.appendSearchPath(cmdLine.getEnvironment(), EnvParameterNames.DYLD_INSERT_LIBRARIES, toInject.getPath());
    }
  }
