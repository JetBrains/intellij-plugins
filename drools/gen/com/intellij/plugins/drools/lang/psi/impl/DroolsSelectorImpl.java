...
public class DroolsSelectorImpl extends DroolsPsiCompositeElementImpl implements DroolsSelector {

  public DroolsSelectorImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public DroolsInnerCreator getInnerCreator() {
    return findChildByClass(DroolsInnerCreator.class);
  }
