...
public class DroolsExclusiveOrExprImpl extends DroolsExpressionImpl implements DroolsExclusiveOrExpr {

  public DroolsExclusiveOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
