...
public class DroolsLhsPatternImpl extends DroolsPsiCompositeElementImpl implements DroolsLhsPattern {
  ...
  public DroolsLhsPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull DroolsVisitor visitor) {
    visitor.visitLhsPattern(this);
  }
  ...
  public DroolsLhsPatternType getLhsPatternType() {
    return findNotNullChildByClass(DroolsLhsPatternType.class);
  }

  @Override
  @Nullable
  public DroolsPatternFilter getPatternFilter() {
    return findChildByClass(DroolsPatternFilter.class);
  }

  @Override
  @Nullable
  public DroolsPatternSource getPatternSource() {
    return findChildByClass(DroolsPatternSource.class);
  }
