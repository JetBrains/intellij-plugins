...
public class DroolsInstanceOfExprImpl extends DroolsExpressionImpl implements DroolsInstanceOfExpr {

  public DroolsInstanceOfExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public DroolsType getType() {
    return findNotNullChildByClass(DroolsType.class);
  }
