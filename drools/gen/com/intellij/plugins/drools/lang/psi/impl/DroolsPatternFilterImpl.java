...
public class DroolsPatternFilterImpl extends DroolsPsiCompositeElementImpl implements DroolsPatternFilter {

  public DroolsPatternFilterImpl(@NotNull ASTNode node) {
    super(node);
  }
