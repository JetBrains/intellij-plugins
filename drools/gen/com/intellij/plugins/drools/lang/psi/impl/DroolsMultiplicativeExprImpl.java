...
public class DroolsMultiplicativeExprImpl extends DroolsExpressionImpl implements DroolsMultiplicativeExpr {

  public DroolsMultiplicativeExprImpl(@NotNull ASTNode node) {
    super(node);
  }
