...
public class DroolsSuperSuffixImpl extends DroolsPsiCompositeElementImpl implements DroolsSuperSuffix {

  public DroolsSuperSuffixImpl(@NotNull ASTNode node) {
    super(node);
  }
