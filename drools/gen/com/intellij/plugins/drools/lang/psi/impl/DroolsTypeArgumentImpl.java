...
public class DroolsTypeArgumentImpl extends DroolsPsiCompositeElementImpl implements DroolsTypeArgument {

  public DroolsTypeArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }
