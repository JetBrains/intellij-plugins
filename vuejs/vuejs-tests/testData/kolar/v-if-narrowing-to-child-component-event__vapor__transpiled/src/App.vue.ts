...
const __VLS_6: __VLS_ResolveEvent<typeof __VLS_4, typeof __VLS_5, 'onClick', 'click', 'click'> = {
/** @type {typeof __VLS_5.click} */
onClick: (__VLS_ctx.foo.bar.baz),
};
var __VLS_7!: Parameters<NonNullable<typeof __VLS_3['expose']>>[0];
