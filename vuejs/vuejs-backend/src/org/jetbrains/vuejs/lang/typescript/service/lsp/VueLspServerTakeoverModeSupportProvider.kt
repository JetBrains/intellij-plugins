...
internal class VueLspServerTakeoverModeSupportProvider :
  JSFrameworkLspServerSupportProvider(VueLspServerTakeoverModeActivationRule) {
  override fun createLspServerDescriptor(project: Project): JSFrameworkLspServerDescriptor =
    VueLspServerTakeoverModeDescriptor(project)
