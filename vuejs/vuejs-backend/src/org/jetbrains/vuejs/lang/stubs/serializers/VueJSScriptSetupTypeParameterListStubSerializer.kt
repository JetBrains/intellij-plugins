...
internal class VueJSScriptSetupTypeParameterListStubSerializer :
  JSStubSerializer<TypeScriptTypeParameterListStub, TypeScriptTypeParameterList>({ SCRIPT_SETUP_TYPE_PARAMETER_LIST }) {
