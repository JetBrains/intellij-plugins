...
class NuxtProjectModuleBuilder : GeneratorNewProjectWizardBuilderAdapter(WebTemplateNewProjectWizard(NuxtProjectGenerator()))

class NuxtProjectTemplateFactory : JavaScriptNewTemplatesFactoryBase() {
  override fun createTemplates(context: WizardContext?): Array<ProjectTemplate> = arrayOf(NuxtProjectGenerator())
}
