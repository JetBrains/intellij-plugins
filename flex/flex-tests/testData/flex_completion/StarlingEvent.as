...
[Event(type="TouchE<caret expected="TouchEvent">v")]
public class StarlingEvent {
    public function StarlingEvent {
        new Quad().addEventListener(<caret expected="Event.ADDED,Event.ADDED_TO_STAGE,Event.REMOVED,Event.REMOVED_FROM_STAGE,TouchEvent.TOUCH">);
    }
}
}
