  ...
  public void testSelectEntireLine() {
    doTest(
      () -> {
        ...
        return new DefaultJSExtractFunctionSettings("created", true, null, FunctionDeclarationType.FUNCTION, JSAttributeList.AccessType.PUBLIC, parametersInfo, null, false);
      },
      "js2"
    );
  }
