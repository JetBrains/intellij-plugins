...
set REQUIRED_FLEXIDE_JVM_ARGS=-Xbootclasspath/a:%FLEXIDE_HOME%/lib/boot.jar -Didea.platform.prefix=Flex -Didea.plugins.compatible.build=9900 -Didea.no.jre.check=true %FLEXIDE_PROPERTIES_PROPERTY% %REQUIRED_FLEXIDE_JVM_ARGS%
