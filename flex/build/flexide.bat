...
SET MAIN_CLASS_NAME=%ASTELLA_MAIN_CLASS_NAME%
IF "%MAIN_CLASS_NAME%" == "" SET MAIN_CLASS_NAME=com.intellij.idea.Main

IF NOT "%ASTELLA_PROPERTIES%" == "" SET IDE_PROPERTIES_PROPERTY="-Didea.properties.file=%ASTELLA_PROPERTIES%"

:: ---------------------------------------------------------------------
:: You may specify your own JVM arguments in .vmoptions file.
:: Put one option per line there.
:: ---------------------------------------------------------------------
SET VM_OPTIONS_FILE=%IDE_BIN_DIR%\astella.exe.vmoptions
SET ACC=
...
SET JVM_ARGS=%ACC% %REQUIRED_JVM_ARGS% %SPECIAL_JVM_ARGS% %REQUIRED_ASTELLA_JVM_ARGS%
...
:: ---------------------------------------------------------------------
:: You may specify additional class paths in ASTELLA_CLASS_PATH variable.
:: It is a good idea to specify paths to your plugins in this variable.
:: ---------------------------------------------------------------------
IF NOT "%ASTELLA_CLASS_PATH%" == "" SET CLASS_PATH=%CLASS_PATH%;%ASTELLA_CLASS_PATH%
...
ECHO No JDK found. Please validate either ASTELLA_JDK or JDK_HOME points to valid JDK installation.
ECHO ---------------------------------------------------------------------
PAUSE
