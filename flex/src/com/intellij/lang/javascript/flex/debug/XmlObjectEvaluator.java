...
public class XmlObjectEvaluator {
  ...
  private static class FakeCompositeNode implements XCompositeNode {
    ...
    public void addChildren(@NotNull XValueChildrenList children, boolean last) {
      ...
      getRootNode().myCallback.evaluated(getRootNode().toPresentableSting(0));
    }
    ...
    public void setMessage(@NotNull String message,
                           final Icon icon, final @NotNull SimpleTextAttributes attributes, @Nullable XDebuggerTreeNodeHyperlink link) {
    }
  }
}
