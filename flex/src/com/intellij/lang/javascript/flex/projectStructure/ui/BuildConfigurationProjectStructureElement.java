    ...
    for (DependencyEntry entry : myBc.getDependencies().getEntries()) {
      if (entry instanceof BuildConfigurationEntry) {
        ...
        if (errorMessage != null) {
          ...
          PlaceInProjectStructure place = new PlaceInBuildConfiguration(this, DependenciesConfigurable.getTAB_NAME(), location);
    ...
    for (VirtualFile libFile : classesRoots) {
      ...
      if (realFile != null && !realFile.isDirectory() && "swc".equalsIgnoreCase(realFile.getExtension())) {
        ...
        if (bcs != null && !bcs.isEmpty()) {
          ...
          final PlaceInProjectStructure placeInPS = new PlaceInBuildConfiguration(this, DependenciesConfigurable.getTAB_NAME(), location);
          ...
          final ConfigurationErrorQuickFix quickFix = new ConfigurationErrorQuickFix(quickFixName) {
            ...
            public void performFix() {
              ...
              place.putPath(CompositeConfigurable.TAB_NAME, DependenciesConfigurable.getTAB_NAME());
