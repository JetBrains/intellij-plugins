...
public final class PlatformDataKeys {
  ...
  public static var MODULE:ModuleDataKey;
...
class ModuleDataKey extends DataKey {
  public function getData(dataContext:DataContext):Module {
    return Module(dataContext.getData(this));
  }
}
