...
public class StyleTest extends BaseTestCase {
  public function emptyForCheckLibrariesCssDefaults():void {
    ...
    for each (var l:Library in librarySet.items) {
      ...
      else if (l.file.name.indexOf("framework") == 0 && l.inheritingStyles != null) {
  ...
  public function App2():void {
    ...
    var app1:Object = DocumentFactoryManager(project.getComponent(DocumentFactoryManager)).getById(0).document.uiComponent;
