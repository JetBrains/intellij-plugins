...
public class LibraryCollector {
  ...
  public static
  @NotNull
  OriginalLibrary createOriginalLibrary(@NotNull final VirtualFile virtualFile, @NotNull final VirtualFile jarFile,
    ...
    if (library == null) {
      library = new OriginalLibrary(virtualFile.getNameWithoutExtension() + "." + Integer.toHexString(path.hashCode()), jarFile, 
      fromSdk);
