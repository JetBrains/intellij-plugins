...
public class LibraryCollector {
  final List<OriginalLibrary> externalLibraries = new ArrayList<OriginalLibrary>();
  final List<OriginalLibrary> sdkLibraries = new ArrayList<OriginalLibrary>();
  ...
  public void collect(Module module, Consumer<OriginalLibrary> initializer) {
    Sdk sdk = null;
