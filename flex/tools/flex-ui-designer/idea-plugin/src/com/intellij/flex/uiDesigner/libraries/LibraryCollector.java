...
class LibraryCollector {
  ...
  private void globalCatalogForTests(SdkType sdkType) {
    if (ApplicationManager.getApplication().isUnitTestMode()) {
      ...
      String name = (sdkType instanceof FlexSdkType ? "player" : "air") + "-catalog.xml";
      File file = new File(DebugPathManager.getTestDataPath() + "/lib/playerglobal", name);
      assert file.exists();
      try {
        globalLibrary = new LightVirtualFile(name, XmlFileType.INSTANCE, IOUtil.getCharSequence(file));
      }
      catch (IOException e) {
