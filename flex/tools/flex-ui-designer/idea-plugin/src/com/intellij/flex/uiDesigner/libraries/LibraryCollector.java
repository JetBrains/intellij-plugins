...
public class LibraryCollector {
  final List<SwfLibrary> externalLibraries = new ArrayList<SwfLibrary>();
  final List<SwfLibrary> sdkLibraries = new ArrayList<SwfLibrary>();
  ...
  public void collect(Module module, Consumer<SwfLibrary> initializer) {
    Sdk sdk = null;
  ...
  private void collectFromLibraryOrderEnrty(LibraryOrderEntry libraryOrderEntry, Consumer<SwfLibrary> initializer) {
