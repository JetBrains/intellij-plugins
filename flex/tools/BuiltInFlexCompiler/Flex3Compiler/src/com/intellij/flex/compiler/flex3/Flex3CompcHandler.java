...
public class Flex3CompcHandler extends Flex3Handler {
  ...
  public Configuration processConfiguration(final String[] params) throws ConfigurationException, IOException {
    ...
    return flex2.tools.Compiler.processConfiguration(ThreadLocalToolkit.getLocalizationManager(), "compc", params, cfgbuf,
  ...
  public Builder createBuilder(final Configuration configuration)
    ...
    Flex3MxmlcHandler.setupConfiguration(library, configuration);
    ...
    final List fileList = flex2.compiler.API.getVirtualFileList(compcConfiguration.getIncludeSources(),
                                                                new HashSet<String>(
                                                                  Arrays.asList(flex2.tools.API.getSourcePathMimeTypes())));
