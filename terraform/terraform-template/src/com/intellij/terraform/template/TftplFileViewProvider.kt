...
internal class TftplFileViewProvider(psiManager: PsiManager,
  ...
  override fun getBaseLanguage(): Language = TftplLanguage
...
private val TEMPLATE_FRAGMENT: IElementType = OuterLanguageElementType("TerraformTemplateSegmentElementType", TftplLanguage)
private val TEMPLATE_DATA: IElementType = TemplateDataElementType("TerraformTemplateTextElementType",
                                                                  TftplLanguage,
                                                                  TftplTokenTypes.DATA_LANGUAGE_TOKEN_UNPARSED,
                                                                  TEMPLATE_FRAGMENT)