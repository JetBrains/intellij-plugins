...
internal object TerragruntPsiPatterns {
  ...
  fun getTerragruntRootBlockPattern(identifier: String) = createBlockPattern(identifier)
    .withParent(TerragruntFile)

  fun getStackRootBlockPattern(identifier: String) = createBlockPattern(identifier)
