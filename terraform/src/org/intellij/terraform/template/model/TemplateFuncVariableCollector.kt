...
package org.intellij.terraform.template.model
...
internal enum class TftplVariableType(@Nls val presentableName: String, val icon: Icon) {
  LOOP_VARIABLE(HCLBundle.message("tftpl.loop.variable.title"), AllIcons.General.InlineRefreshHover),
  EXTERNAL_VARIABLE(HCLBundle.message("tftpl.external.variable.title"), AllIcons.Ide.ConfigFile)
}
