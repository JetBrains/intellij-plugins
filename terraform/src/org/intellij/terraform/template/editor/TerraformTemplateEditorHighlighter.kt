...
private class TerraformTemplateEditorHighlighterProvider : EditorHighlighterProvider {
  override fun getEditorHighlighter(project: Project?,
    ...
    return TerraformTemplateEditorHighlighter(project, virtualFile, colors, inferredDataLanguage)
  }
...
internal class TerraformTemplateEditorHighlighter(project: Project?,
                                                  file: VirtualFile?,
