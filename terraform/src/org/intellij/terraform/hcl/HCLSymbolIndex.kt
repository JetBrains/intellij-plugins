...
class HCLSymbolIndex : ScalarIndexExtension<String>() {
  private val supportedFileTypes: Set<LanguageFileType> =
    setOf(HclFileType, TerraformFileType, OpenTofuFileType, TerragruntFileType, TfComponentFileType, TfDeployFileType)
  ...
  override fun getInputFilter(): FileBasedIndex.InputFilter {
    return object : DefaultFileTypeSpecificInputFilter(*supportedFileTypes.toTypedArray()) {
  ...
  override fun getIndexer(): DataIndexer<String, Void, FileContent> = DataIndexer { inputData ->
    ...
    if (inputData.fileType in supportedFileTypes) {
...
internal val NAME: ID<String, Void> = ID.create("HCLSymbolIndex")