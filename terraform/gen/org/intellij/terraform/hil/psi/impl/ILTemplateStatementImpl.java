...
public abstract class ILTemplateStatementImpl extends ILExpressionBase implements ILTemplateStatement {

  public ILTemplateStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull ILGeneratedVisitor visitor) {
    visitor.visitILTemplateStatement(this);
  }
