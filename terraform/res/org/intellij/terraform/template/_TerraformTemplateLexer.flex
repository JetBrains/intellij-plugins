...
%state DATA_LANGUAGE_SEGMENT TEMPLATE_LANGUAGE_SEGMENT IL_EXPRESSION QUOTED_STRING
...
//  {HIL_START}                   { return BAD_CHARACTER; }
//  {TEMPLATE_START}              { return BAD_CHARACTER; }
  {HIL_STOP}                    {
...
<QUOTED_STRING> {
  {QUOTE}                       { yybegin(DATA_LANGUAGE_SEGMENT); }
  [^]                           {}
  <<EOF>>                       {
                                  yybegin(YYINITIAL);
                                  return DATA_LANGUAGE_TOKEN_UNPARSED;
