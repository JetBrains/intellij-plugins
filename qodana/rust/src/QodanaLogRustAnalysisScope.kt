...
private val log = logger<QodanaLogRustAnalysisScope>()

class QodanaLogRustAnalysisScope : QodanaWorkflowExtension {
  override suspend fun afterConfiguration(config: QodanaConfig, project: Project) {
    ...
    ConsoleLog.info("Analysis scope: $packageCount packages across ${cargoProjects.allProjects.size} Cargo projects")
  }
}
