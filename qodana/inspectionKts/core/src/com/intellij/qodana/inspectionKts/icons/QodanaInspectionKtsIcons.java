package com.intellij.qodana.inspectionKts.icons;
 ...
 */
public final class QodanaInspectionKtsIcons {
  private static @NotNull Icon load(@NotNull String path, int cacheKey, int flags) {
    return IconManager.getInstance().loadRasterizedIcon(path, QodanaInspectionKtsIcons.class.getClassLoader(), cacheKey, flags);
  }
