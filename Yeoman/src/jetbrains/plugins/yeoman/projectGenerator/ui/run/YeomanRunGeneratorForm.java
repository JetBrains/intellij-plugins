...
public class YeomanRunGeneratorForm implements Disposable {
  ...
  private final JPanel myFormContainerPanel;
  private final JLabel myGeneratorTitle;
  private final JPanel myConsolePanel;
  private final JPanel myTopRunningLabelPanel;
  ...
  public YeomanRunGeneratorForm(String directoryForCreate,
    ...
    myGlobalEventHandler = handler;
    {
      ...
      myMainPanel.setPreferredSize(new Dimension(550, 310));
      myFormContainerPanel = new JPanel();
      myFormContainerPanel.setLayout(new BorderLayout(0, 0));
      myMainPanel.add(myFormContainerPanel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                                                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                                                                GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                                                                null, null, null, 0, false));
      myConsolePanel = new JPanel();
      myConsolePanel.setLayout(new BorderLayout(0, 0));
      myMainPanel.add(myConsolePanel, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_SOUTH, GridConstraints.FILL_HORIZONTAL,
                                                          GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                                                          GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null,
                                                          null, null, 1, false));
      myTopRunningLabelPanel = new JPanel();
      myTopRunningLabelPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 0, 5));
      myMainPanel.add(myTopRunningLabelPanel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_NORTH, GridConstraints.FILL_HORIZONTAL,
                                                                  GridConstraints.SIZEPOLICY_CAN_SHRINK |
                                                                  GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED,
                                                                  null, null, null, 0, false));
      myGeneratorTitle = new JLabel();
      myGeneratorTitle.setText("");
      myTopRunningLabelPanel.add(myGeneratorTitle);
    }
  ...
  private void showConsole() {
    ...
    final HideableDecorator decorator =
      new HideableDecorator(myConsolePanel, YeomanBundle.message("separator.yeoman.console.output"), false);
