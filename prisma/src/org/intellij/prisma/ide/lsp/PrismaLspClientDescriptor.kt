...
class PrismaLspClientDescriptor(project: Project)
  : JSNodeLspClientDescriptor(project, PrismaLspServerActivationRule, PrismaBundle.message("prisma.framework.name")) {
