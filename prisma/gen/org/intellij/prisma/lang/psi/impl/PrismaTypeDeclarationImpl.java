...
public class PrismaTypeDeclarationImpl extends PrismaTableEntityDeclarationMixin<PrismaTypeDeclarationStub> implements PrismaTypeDeclaration {

  public PrismaTypeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public PrismaTypeDeclarationImpl(@NotNull PrismaTypeDeclarationStub stub, @NotNull IStubElementType<?, ?> type) {
    super(stub, type);
  }
