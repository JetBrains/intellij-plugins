...
class Angular2DirectiveExportAs(
  ...
  override val sourceElement: PsiElement? = null,
  override val textRangeInSourceElement: TextRange? = null,
) : Angular2Symbol, SearchTarget, RenameTarget, WebSymbolDeclaredInPsi {

  override val psiContext: PsiElement
    get() = directive.sourceElement

  override val priority: WebSymbol.Priority
    get() = WebSymbol.Priority.NORMAL

  override val project: Project
    get() = directive.sourceElement.project
  ...
  override fun createPointer(): Pointer<out Angular2DirectiveExportAs> {
    ...
    return Pointer {
      ...
      val sourceElement = sourceElementPtr?.let { it.dereference() ?: return@Pointer null }
