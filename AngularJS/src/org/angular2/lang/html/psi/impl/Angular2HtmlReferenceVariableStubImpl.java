...
public class Angular2HtmlReferenceVariableStubImpl extends JSVariableStubBaseImpl<JSVariable> implements JSVariableStub<JSVariable> {
  public Angular2HtmlReferenceVariableStubImpl(JSVariable clazz,
                                               final StubElement parent,
                                               @NotNull JSStubElementType<?, JSVariable> elementType) {
    super(clazz, parent, elementType);
  }

  public Angular2HtmlReferenceVariableStubImpl(final StubInputStream dataStream,
  ...
  public JSVariable createPsi() {
    return new Angular2HtmlReferenceVariableImpl(this);
  }
