...
class Angular2DocumentationTest : Angular2TestCase("documentation") {
  ...
  fun testBlock() = doTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5,
                           Angular2TestModule.ANGULAR_COMMON_17_1_0_NEXT_5,
                           ext = "html")

  fun testSecondaryBlock() = doTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5,
                                    Angular2TestModule.ANGULAR_COMMON_17_1_0_NEXT_5,
                                    ext = "html")

  fun testBlockParameter() = doTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5,
                                    ext = "html")

  fun testForBlockImplicitVariableInLet() = doTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5,
                                                   ext = "html")

  fun testForBlockImplicitVariableInExpr() = doTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5,
                                                    ext = "html")

  fun testDeferBlockPrefetchOn() = doTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5, ext = "html")

  fun testDeferBlockOnTrigger() = doTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5, ext = "html")
