...
class Angular2FormattingTest : Angular2TestCase("formatting") {
  ...
  fun testBasicBlocks() = doFormattingTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5, extension = "html")

  fun testDeferBlock() = doFormattingTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5, extension = "html")
