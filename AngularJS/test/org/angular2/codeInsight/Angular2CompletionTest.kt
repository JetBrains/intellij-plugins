...
class Angular2CompletionTest : Angular2TestCase("completion") {
  ...
  fun testPrimaryBlocksTopLevelText() =
    doLookupTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5, extension = "html", lookupItemFilter = ::notAnElement)
  ...
  fun testIfBlock() =
    doTypingTest("if\n", Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5)
  ...
  fun testIfBlockParameters() =
    doLookupTest(Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5, extension = "html", checkDocumentation = true)

  fun testIfBlockParameterTyping() =
    doTypingTest("\nfoo", Angular2TestModule.ANGULAR_CORE_17_1_0_NEXT_5)
