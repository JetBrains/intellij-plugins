...
@Component({
    ...
    template: `
      <div foo
           <error descr="Cannot assign to input readonly field because it is a read-only property.">[readonlyField]</error>="value"
      ...
      ></div>
      <cmp
              <error descr="Cannot assign to input readonly field because it is a read-only property.">[readonlyField]</error>="readonlyField"
