...
public class WebAssemblyParamImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyParam {

  public WebAssemblyParamImpl(@NotNull ASTNode node) {
    super(node);
  }
