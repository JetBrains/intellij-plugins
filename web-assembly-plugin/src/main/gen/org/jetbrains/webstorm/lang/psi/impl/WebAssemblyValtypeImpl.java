...
public class WebAssemblyValtypeImpl extends ASTWrapperPsiElement implements WebAssemblyValtype {

  public WebAssemblyValtypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitValtype(this);
  }
