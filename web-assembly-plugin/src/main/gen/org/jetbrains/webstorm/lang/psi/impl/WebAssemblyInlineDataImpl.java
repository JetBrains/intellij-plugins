...
public class WebAssemblyInlineDataImpl extends ASTWrapperPsiElement implements WebAssemblyInlineData {

  public WebAssemblyInlineDataImpl(@NotNull ASTNode node) {
    super(node);
  }
