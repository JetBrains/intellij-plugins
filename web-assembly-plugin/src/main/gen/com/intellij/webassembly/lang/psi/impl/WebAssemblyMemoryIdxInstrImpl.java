...
import com.intellij.webassembly.lang.psi.WebAssemblyMemoryIdxInstr;
...
public class WebAssemblyMemoryIdxInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyMemoryIdxInstr {

  public WebAssemblyMemoryIdxInstrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitMemoryIdxInstr(this);
  }
