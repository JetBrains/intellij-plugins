...
import com.intellij.webassembly.lang.psi.WebAssemblyTypeuseTyperef;
...
public class WebAssemblyTypeuseTyperefImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyTypeuseTyperef {

  public WebAssemblyTypeuseTyperefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitTypeuseTyperef(this);
  }
