...
import com.intellij.webassembly.lang.psi.WebAssemblyCallInstr;
...
public class WebAssemblyCallInstrImpl extends WebAssemblyNamedReferencedElementImpl implements WebAssemblyCallInstr {

  public WebAssemblyCallInstrImpl(@NotNull ASTNode node) {
    super(node);
  }
