...
import com.intellij.webassembly.lang.psi.WebAssemblyLexerTokens;
...
public class WebAssemblyLexerTokensImpl extends ASTWrapperPsiElement implements WebAssemblyLexerTokens {

  public WebAssemblyLexerTokensImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitLexerTokens(this);
  }
