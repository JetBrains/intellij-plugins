...
import com.intellij.webassembly.lang.psi.WebAssemblyAligneq;
...
public class WebAssemblyAligneqImpl extends ASTWrapperPsiElement implements WebAssemblyAligneq {

  public WebAssemblyAligneqImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WebAssemblyVisitor visitor) {
    visitor.visitAligneq(this);
  }
