...
import com.intellij.webassembly.lang.psi.WebAssemblyComment;
...
public class WebAssemblyCommentImpl extends ASTWrapperPsiElement implements WebAssemblyComment {

  public WebAssemblyCommentImpl(@NotNull ASTNode node) {
    super(node);
  }
